#ifndef _INFRARED_RAY_WIFICONFIGWEB_H_
#define _INFRARED_RAY_WIFICONFIGWEB_H_
...
char *_doGenWiFiConfigPage() {
  char *strWebPage = (char*)(malloc(4096));
  const char* strHtmlTemplate = "\
  <html> \
  <head> \
  <meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/> \
  <title>WiFi Config Page For InfraredRayCtrl</title> \
  <style> \
      html { \
          font-family: Arial; \
...
#endif /* _INFRARED_RAY_WIFICONFIGWEB_H_ */
