#ifndef _JOYSTICK_WIFISTATION_H_
#define _JOYSTICK_WIFISTATION_H_
...
bool wifi_init_sta(char *wifiSSID, char *wifiPwd, const char *domainName) {
  ...
  esp_err_t err = tcpip_adapter_set_hostname(TCPIP_ADAPTER_IF_STA, domainName);
  if (err) {
...
#endif /* _JOYSTICK_WIFISTATION_H_ */
