...
static const char* HMC5883L_TAG = "HMC5883L";


void _funcInitHMC5883L(void* pvParameters) {
    ESP_LOGI(HMC5883L_TAG, ">> HMC5883L is initializing ...");
    i2c_config_t conf;
    ...
    while(1) {
        ...
        ESP_LOGI(HMC5883L_TAG, "angle: %d, x: %d, y: %d, z: %d", angle, x, y, z);
...
void initHMC5883L() {
  xTaskCreate(&_funcInitHMC5883L, "_funcInitHMC5883L", G_TASK_STACK_SIZE * 2, NULL, tskIDLE_PRIORITY + TASK_LOOP_PRIORITY, NULL);
}
