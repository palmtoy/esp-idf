...
/**
 * GPIO18:  input, pulled up, interrupt from rising edge and/or falling edge.
 */
#define GPIO_INPUT_INFRARED_RAY 18
#define GPIO_INPUT_PIN_SEL 1ULL << GPIO_INPUT_INFRARED_RAY
#define ESP_INTR_FLAG_DEFAULT 0

#define GPIO_LED_BLUE 4  // esp32c3 on board green LED
